...
#ifndef AXTL_STREAM_MOCK_H
#define AXTL_STREAM_MOCK_H
...
class StreamMock final : public Stream
{
  public:
     ...
     * buffer to -1 (no data) and sets the tracker indices to point to the beginning of each buffer (to 0). This
